...
def load_data(data_url : str)->pd.DataFrame:
   try:
    ...
    logger.debug('Data loaded from ',data_url)
    return df
   except pd.errors.ParserError as e:
     logger.error('Failed to parse the csv file',e)
     raise
   except Exception as e:
      logger.error("Unexpected error occured while loading data",e)
      raise
...
def main():  
    try:
      ...
      data_path='https://raw.githubusercontent.com/devansh1996/MLOPS-with-DVC/refs/heads/main/spam.csv'
      ...
      logger.error('failed in data load',e)
      raise
